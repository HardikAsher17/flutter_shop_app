...
class _ProductsOverviewScreenState extends State<ProductsOverviewScreen> {
  ...
  @override
  void initState() {
    // Provider.of<Products>(context).fetchAndSetProducts(); //context doesn't work in init
    // Future.delayed(Duration.zero).then((_) { //this is a loophole over the above statement but it is only a hack
